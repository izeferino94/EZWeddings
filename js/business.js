...
function loadInfo() {
    ...
    page_picture.setAttribute("src", "img/title_bg.jpeg");
    business_title.firstChild.innerHTML = "Fairbaks Ranch Country Club";
    
    var business_picture = document.getElementById("business-picture");
    business_picture.setAttribute("src", "img/wedding_venue_1.jpg");
    ...
    b.innerHTML = "E-mail:";
    i.innerHTML = " info.frcc@bayclubs.com";
    contact_info.appendChild(b);
    contact_info.appendChild(i);
    contact_info.appendChild(br);
    ...
    br = document.createElement("BR");
    b.innerHTML = "Address:";
    i.innerHTML = " 15150 San Dieguito Road, Rancho Santa Fe, CA 92067";
    contact_info.appendChild(b);
    contact_info.appendChild(i);
    contact_info.appendChild(br);
}
